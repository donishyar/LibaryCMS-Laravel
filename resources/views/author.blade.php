...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="lg:w-3/4 mx-auto py-8 px-6 bg-white rounded-xl">
            ...
            <div class="mb-6">
                ...
                <form class="flex flex-col space-y-4" method="POST" action="/author">
                    @csrf
                    <input type="text" name="author" placeholder="add an author" class="py-3 px-4 bg-gray-100 rounded-xl">
                ...
                <div class="mt-2">
                    ...
                    >
                        <div class="flex-1 pr-8">
                            <h3 class="text-lg font-semibold">{{$item->author}}</h3>
                        </div>

                        <div class="flex space-x-3">

                            <form method="post" action="/author/{{$item ->id}}">
                                @csrf
                            ...
                            <form method="get" action="/author/{{$item ->id}}">
                                @csrf
